...
# Version 1.2.2.4
#		3. Add IxFilter Father object, inherited by StatsFilter and CaptureFilter
# Version 1.3.2.15
#		4. Change vlan_pri field to hex in IxFilter.config
# Version 1.4.2.16
#		5. Modify ip_dscp field value and ip_tos field value in IxFilter.config
# Version 1.5.3.7
#		6. Add IPv6 in IxFilter.config -packet_type
# Version 1.6.6.20
#		7. Change filter_mask {ff ff...ff} into {00 00 ... 00}
# Version 1.7.8.27
#       8. pattern set mode change from {AA BB CC} to {AABBCC}
#       9. clear old configuration when call IxFilter.config
...
body IxFilter::config { args } {
    ...
    set tag "body IxFilter::config [info script]"
Deputs "----- TAG: $tag -----"
#param collection
Deputs "Args:$args "
